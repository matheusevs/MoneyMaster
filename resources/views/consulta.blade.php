...
<html>
    ...
    <body onload="carregaListaDespesas()">
        ...
        <div class="container">
            ...
            <div class="row  mb-5">
                ...
                <div class="col-md-2 d-flex justify-content-end">
                    <button type="button" class="btn btn-primary" onclick="pesquisaDespesas()">
        ...
        <!-- Modal -->
        <div class="modal fade" id="modalApagaDespesa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" id="modal_btn_cancelar" data-dismiss="modal"></button>
                        <button type="button" id="modal_btn_confirmar" data-dismiss="modal"></button>
                    </div>
                </div>
            </div>
        </div>
